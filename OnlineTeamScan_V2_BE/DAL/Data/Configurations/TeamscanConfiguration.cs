...
namespace DAL.Data.Configurations
{
    public class TeamscanConfiguration : Profile, IEntityTypeConfiguration<Teamscan>
    {
        ...
        public void Configure(EntityTypeBuilder<Teamscan> builder)
        {
            ...
            builder.Property(t => t.ScoreTrust).HasColumnName("score_trust").HasColumnType("decimal(3,2)");
            builder.Property(t => t.ScoreConflict).HasColumnName("score_conflict").HasColumnType("decimal(3,2)");
            builder.Property(t => t.ScoreCommitment).HasColumnName("score_commitment").HasColumnType("decimal(3,2)");
            builder.Property(t => t.ScoreAccountability).HasColumnName("score_accountability").HasColumnType("decimal(3,2)");
            builder.Property(t => t.ScoreResults).HasColumnName("score_results").HasColumnType("decimal(3,2)");
